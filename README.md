...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/ruffled-still-darkness-fd78
```

A live public deployment of this template is available at [https://ruffled-still-darkness-fd78.templates.workers.dev](https://ruffled-still-darkness-fd78.templates.workers.dev)
